...
function highlightText(text: string, tokens: string[]): React.ReactNode {
  return highlightMatches(text, tokens, 'var(--vscode-editor-findMatchHighlightBackground, rgba(234,92,0,0.33))');
}
        ...
        return (
          <div key={group.kind}>
            ...
            >
              ...
              <span>{t(GROUP_LABEL_KEYS[group.kind])}</span>
            </div>
