 ...
 * распарсенных запросах, см. docs/development/known-issues.md. Этот файл делает ту разовую
...
export function run(): void {
  ...
  if (report.hits.length > 0) {
    console.error(
      '\nНайдены реальные вызовы виртуальных таблиц с потерянными 3+ аргументами — см. docs/development/known-issues.md.'
    );
    process.exit(1);
  }
}
