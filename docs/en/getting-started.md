...
inserts a generated BSL result-processing wrapper. Neither command executes the
query.
...
Configure [metadata](metadata.md), learn the [designer](query-designer.md), and
review the [round-trip limits](limitations.md) before editing complex handwritten
queries.
